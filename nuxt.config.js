export default {
  ...
  head: {
    ...
    link: [
      ...
      {
        rel: 'stylesheet' , href:'https://fonts.googleapis.com/css2?family=Open+Sans:ital,wght@0,300;0,400;0,600;0,700;0,800;1,300;1,400;1,600;1,700;1,800&display=swap', media:'all', disabled:''
      },
      {
        rel: 'stylesheet' , href:'https://fonts.googleapis.com/css2?family=Kurale&family=Merriweather:ital,wght@0,300;0,400;0,700;1,300;1,400;1,700&display=swap', media:'all', disabled:''
      },
    ]
  },
  server:{
