<template>
  <div id="company" class="page">
    <b-container>
      ...
      <p class="text"><span class="emphasized text">"{{information.name_company}}" </span> - частное охранное предприятие, обеспечивающее комплексную безопасность личности, предпринимательской деятельности, мероприятий, и всех, кто нуждается в охране на всей территории во всех субъектах РФ.</p>
    ...
    data() {
      return {
        ...
        ProfessionalSkills:[
          ...
          {skill:"для улучшения личностных качеств - проходят курсы по военной медицине, контрнаружному наблюдению, техническим, правовым, психологическим и этическим нормам поведения частных охранников;",},
        ...
        StagesOfWork:[
          {index:'01', name_stage:"заявка от клиента", descr_stage:"Если Вам необходима охрана, Вы можете позвонить по номеру <a href=tel:" + Information.phone + " >"  + Information.phone +"</a>" + "  или же отправить форму обратной связи и мы сами перезвоним Вам.",},
          {index:'02', name_stage:"выезд специалиста", descr_stage:"В удобное для Вас время, на территорию Вашего объекта выезжает специалист нашей компании для обследования объекта на предмет уязвимостей и оценки потенциальных угроз.",},
          {index:'03', name_stage:"индивидуальный план на работу", descr_stage:"Учитывая требования клиента, по результатам осмотра территории или опроса Клиента, составляется индивидуальный план на необходимое количество постов и их режима работы.",},
          {index:'04', name_stage:"подбор персонала под объект", descr_stage:"Исходя из специфики конкретного объекта/личности и прочих определенных условий подбираются сотрудники наиболее ориентированные на выполнение конкретной задачи.",},
          {index:'05', name_stage:"подписание договора", descr_stage:"По согласованию всех особенностей работы производится расчет и заключается договор на оказание охранных услуг частным охранным предприятием, с описанием подробной концепции обеспечения безопасности охраняемого объекта.",},
          {index:'06', name_stage:"проверка работы", descr_stage:"Для контроля качества оказываемых услуг постоянно проводятся как плановые, так и внеплановые проверки персонала для оценки их эффективности. По результатам проверки при необходимости применяются меры по оптимизации охраны.",},
        ]
      }
    }
  }
