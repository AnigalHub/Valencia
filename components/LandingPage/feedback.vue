      ...
      <b-container>
        <b-row>
          ...
          <b-col>
            ...
            <a href="" class="call_telephone">+7(999)999-99-99</a>
            <p class="text">
              Оставьте заявку или позвоните по телефону, мы ответим Вам на все интересующие
              Вас вопросы и представим индивидуальные решения для Вашего объекта.
            </p>
          </b-col>
        </b-row>
      </b-container>
...
<style scoped>
  #Feedback{
    padding: 2% 0;
    background: url("../../static/55.jpg") 100% 100% no-repeat;
