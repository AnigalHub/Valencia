<template>
  <div>
    <form name="sentMessage" id="Form">
      ...
      <input v-model="feedback.name" class="form-control" id="name" name="name" data-validation-required-message="Пожалуйста, введите Ваше имя">
      <label for="phone">Ваш телефон:</label>
      <input v-model="feedback.phone" class="form-control" v-mask="'+7 (###) ###-##-##'" id="phone" name="phone" data-validation-required-message="Пожалуйста, введите Номер телефона">
