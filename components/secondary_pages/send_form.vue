<template>
  <div>
    <form name="sentMessage" id="Form">
      ...
      <input v-model="feedback.phone" type="tel" class="form-control" v-mask="'+7 (###) ###-##-##'" placeholder="+7(___)___-__-__" pattern="[+]7\([0-9]{3}\)[0-9]{3}-[0-9]{2}-[0-9]{2}" id="phone" name="phone" required="" data-validation-required-message="Пожалуйста, введите Номер телефона">
